        ...
        private void PaintLineNumbers()
        {
            ...
            for (int i = 0; i <= n; i++)
            {
                ...
                if (i == n) // last line?
                {
                    ...
                    r4 = new Rectangle(1, py, w2, Font.Height);
                }
                else
                {
                    if (p.Y <= py) continue;
                ...
                g.FillRectangle(new SolidBrush(Color.LightGray), r4);
                ...
                g.DrawString(s, NumberFont, new SolidBrush(Color.DarkGray), r4, _stringDrawingFormat); /*Scrive numero*/
